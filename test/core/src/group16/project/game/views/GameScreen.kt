...
import group16.project.game.models.GameModel
import com.badlogic.gdx.graphics.OrthographicCamera

class GameScreen(val gameController: StarBattle) : View() {
    private val screenRect = Rectangle(0f, 0f, Configuration.gameWidth * 2, Configuration.gameHeight * 2)
    private val camera = OrthographicCamera()
    private val game = GameModel(screenRect, camera)
